...
import openai
# Apply the API Key this is my api anyone can generate at openai.com
openai.api_key = "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"
